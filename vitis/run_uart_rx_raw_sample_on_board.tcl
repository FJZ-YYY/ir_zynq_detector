...
set elf_file     [file normalize [file join $repo_root build vitis_raw_sample irdet_uart_rx_raw_sample Debug irdet_uart_rx_raw_sample.elf]]
set ps7_init_tcl [file normalize [file join $repo_root build vitis_raw_sample irdet_uart_rx_raw_sample _ide psinit ps7_init.tcl]]
...
if {![file exists $elf_file]} {
    error "ELF file not found: $elf_file. Build the raw-sample Vitis app first."
}
...
puts "INFO: Raw-sample UART ELF downloaded and CPU resumed."
